...
type GuideDetailsScreenProps = RouteProp<GuideStackParamList, "GuideDetails">;

type Props = {
  route: GuideDetailsScreenProps;
  navigation: any;
};
...
const GuideDetailsScreen = ({ route, navigation }: Props) => {
    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View className="p-4">
          ...
          <View className="border-t border-t-gray-200 pt-4 mb-6">
            <Text className="text-lg font-semibold text-gray-800 mb-2">
              Details
            </Text>
            ...
            <View className="border-t border-t-gray-200 pt-4 mb-6">
              ...
              {itinerary.map((item, index) => (
                <View key={index} className="flex-row items-start mb-2">
                  <Text className="text-gray-800 font-medium text-base mr-2">
                    •
                  </Text>
                  <Text className="text-gray-800 font-medium text-base mr-2">
                    {item}
